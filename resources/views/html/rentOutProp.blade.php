                            ...
                            <div class="row">
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <div class="col my-3">
                                                ...
                                                <h3 class="fw-bold text-primary" style="font-size: 17px;">
                                                    Rent: <small
                                                        class="text-dark">{{ number_format((float) str_replace(',', '', $process->prop_rent), 0) }}</small>
                                                </h3>
                                                <h3 class="fw-bold text-primary" style="font-size: 17px;">
                                                    Renter: <small class="text-dark">{{ $process->tenant_name }}</small>
                                                </h3>
                                                <h3 class="fw-bold text-primary" style="font-size: 17px;">
                                                    Renter Contact: <small
                                                        class="text-dark">{{ $process->tenant_contact }}</small>
                                                </h3>
                                                <h3 class="fw-bold text-primary" style="font-size: 17px;">
                                                    Renter CNIC: <small
                                                        class="text-dark">{{ $process->tenant_cnic }}</small>
                                                </h3>
                                                <h3 class="fw-bold text-primary" style="font-size: 17px;">
                                                    Advance: <small
                                                ...
                                                <h3 class="fw-bold text-primary" style="font-size: 17px;">
                                                    Commission: <small
                                                        class="text-dark">{{ number_format((float) str_replace(',', '', $process->commision), 0) }}</small>
                                                </h3>
                                                <h3 class="fw-bold text-primary" style="font-size: 17px;">
                                                    Description:
                                ...
                                <div class="col-lg-12 mb-4">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <form action="{{ route('rentProcessUpdate', $process->prop_id) }}"
                                                method="POST">
                                                @csrf
                                                <div class="mb-3">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" id="basic-default-phone"
                                                        class="form-control phone-mask" name="prop_rent"
                                                        value="{{ $process->prop_rent }}" />
                                                </div>
                                                <div class="mb-3">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" id="basic-default-phone"
                                                        class="form-control phone-mask" name="tenant_name"
                                                        value="{{ $process->tenant_name }}" />
                                                </div>
                                                <div class="mb-3">
                                                    <label class="form-label" for="basic-default-phone">Renter
                                                        Contact</label>
                                                    <input type="text" id="basic-default-phone"
                                                        class="form-control phone-mask" name="tenant_contact"
                                                        value="{{ $process->tenant_contact }}" />
                                                </div>
                                                <div class="mb-3">
                                                    <label class="form-label" for="basic-default-phone">Renter
                                                        CNIC</label>
                                                    <input type="text" id="basic-default-phone"
                                                        class="form-control phone-mask" name="tenant_cnic"
                                                        value="{{ $process->tenant_cnic }}" />
                                                </div>
                                                <div class="mb-3">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" id="basic-default-phone"
                                                        class="form-control phone-mask" name="commision"
                                                        value="{{ $process->commision }}" />
                                                </div>
                                                <div class="mb-3">
